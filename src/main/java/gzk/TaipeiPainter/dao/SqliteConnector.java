...
public class SqliteConnector {
	...
	private void createManagementFeesReceivable() {
		String sql = "CREATE TABLE \"management_fees_receivable\" (\n"
				...
				+ "	\"reversed\"	INTEGER,\n"
				+ "	PRIMARY KEY(\"doortablet\",\"zyymm\",\"payment_rmk\")\n"
				+ ");";
	       try (Connection conn = DriverManager.getConnection(dbUrl)) {
	...
	private void createOwnerDoortabletInfo() {
		String sql = "CREATE TABLE \"doortablet_info\" (\n"
				...
				+ "	\"parking_space_square_meters\"	NUMERIC,\n"
				+ "	\"number_of_square_meters_for_management_fee\"	NUMERIC,\n"
				+ "	\"base_management_fee\"	NUMERIC,\n"
				+ "	\"management_fee\"	NUMERIC,\n"
				+ "	\"car_num\"	INTEGER,\n"
				+ "	\"motorcycle_num\"	INTEGER,\n"
				+ "	\"reduction_rate\"	NUMERIC,\n"
				+ "	\"adjusted_management_fee\"	NUMERIC,\n"
				+ "	\"car_cleaning_fee\"	NUMERIC,\n"
				+ "	\"motorcycle_cleaning_fee\"	NUMERIC,\n"
